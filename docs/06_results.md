...
![実機自律走行 GIF プレースホルダ](../assets/videos/_PLACEHOLDER_autonomous_drive.gif)
...
- 環境: Gazebo Harmonic (`pedestrians_moving` world)
- 歩行者が経路上に出現
- STP4 が「待機」を選択
- 歩行者が通り過ぎた後、元の経路を再開
...
![Sim 歩行者迂回 GIF プレースホルダ](../assets/videos/_PLACEHOLDER_sim_pedestrian_detour.gif)
